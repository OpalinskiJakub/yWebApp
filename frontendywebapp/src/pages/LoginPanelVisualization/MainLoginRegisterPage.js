...
class MainLoginRegisterPage extends Component{
    constructor() {
        super();
    }
    ...
    render() {
        return(
            <Container fluid>
                ...
                <Row className="justify-content-center" className="mt-5" style={{paddingLeft:'10%',paddingRight:'10%'}}>
                    ...
                    <Col md={{ span: 2, offset: 2 }} className="mt-5" style={{paddingBottom:'12%',paddingTop:'10%'}}>
                        <Card>
                            <Card.Body>
...
export default MainLoginRegisterPage;